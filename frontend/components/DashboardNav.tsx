    ...
    <div className="max-w-6xl mx-auto relative z-20 pt-8 px-4 md:px-8 lg:px-12">
      ...
      <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-white/10">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <Link
            href="/dashboard"
            className={`px-5 py-2 text-xs font-mono font-bold uppercase tracking-widest rounded transition shadow-sm flex items-center justify-center ${pathname === '/dashboard'
          ...
          <Link
            href="/phishing"
            className={`px-5 py-2 text-xs font-mono font-bold uppercase tracking-widest rounded transition shadow-sm flex items-center justify-center ${pathname === '/phishing'
          ...
          <Link
            href="/url-scan"
            className={`px-5 py-2 text-xs font-mono font-bold uppercase tracking-widest rounded transition shadow-sm flex items-center justify-center ${pathname === '/url-scan'
                ? 'bg-white text-black hover:bg-neutral-200 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)]'
                : 'bg-black/40 text-neutral-400 border border-white/10 hover:text-white hover:bg-white/5'
              }`}
          >
          ...
          <Link
            href="/deepfake-scan"
            className={`px-5 py-2 text-xs font-mono font-bold uppercase tracking-widest rounded transition shadow-sm flex items-center justify-center ${pathname === '/deepfake-scan'
          ...
          <Link
            href="/cyber-help"
            className={`px-5 py-2 text-xs font-mono font-bold uppercase tracking-widest rounded transition shadow-sm flex items-center justify-center ${pathname === '/cyber-help'
          ...
          <Link
            href="/behavior"
            className={`px-5 py-2 text-xs font-mono font-bold uppercase tracking-widest rounded transition shadow-sm flex items-center justify-center ${pathname === '/behavior'
                ? 'bg-white text-black hover:bg-neutral-200 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)]'
                : 'bg-black/40 text-neutral-400 border border-white/10 hover:text-white hover:bg-white/5'
              }`}
          >
